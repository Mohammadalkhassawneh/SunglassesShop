...
class FramesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frame" do
    assert_difference('Frame.count') do
      post frames_url, params: { frame: { description: @frame.description, name: @frame.name, price: @frame.price, status: @frame.status, stock: @frame.stock } }
    end
  ...
  test "should update frame" do
    patch frame_url(@frame), params: { frame: { description: @frame.description, name: @frame.name, price: @frame.price, status: @frame.status, stock: @frame.stock } }
